...
test('LegacyLashMapDiagram accepts a side prop and LashMapDiagram forwards it via diagramProps', () => {
  assert.ok(rendererSource.includes('function LegacyLashMapDiagram({ zones, peakIdx, spikeGeom, curve, hoveredZone, setHoveredZone, curl, technique, side, lang, zoneNames, curlByZone, lengthRangeByZone }) {'));
